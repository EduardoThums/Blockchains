...
import fabric.ipfs.example.service.ipfs.GetFileByHashService;
...
public class IpfsController {
	...
	@GetMapping
	public ResponseEntity<String> findFileByHash(@RequestParam("hash") String hash) throws IOException {
