...
public class FabricController {
	...
	public void queryByCameraIdAndTimestampRange(@PathVariable("cameraId") long cameraId,
	                                             @RequestParam("startDate") long startDate,
	                                             @RequestParam("endDate") long endDate,
	                                             @RequestParam("logStartDate") long logStartDate) throws IOException, ProposalException, InvalidArgumentException {

		queryByCameraIdAndTimestampRangeService.queryByCameraIdAndTimestampRange(cameraId, startDate, endDate, logStartDate);
	}
}
